            ...
            <table class="table my-4">
                <thead class="thead-dark">
                  <tr>
                    ...
                    <th scope="col" colspan=2 style="text-align:center">Change Status</th>
                    
                  </tr>
                  <?php
                  $user=$_SESSION['username'];
                  //echo gettype($user);
                  $sql="SELECT o.orderid,o.uname, p.name, p.brand, p.model, p.picture, p.price, o.status
                  ...
                  if($result){
                    while($row = mysqli_fetch_assoc($result)){
                      ...
                      <a href="status.php?statusid='.$oid.'" class="text-light">Set as Delivered</a>
                    </button>
                  </td> 
                    <td>
                      <button class="btn btn-danger btn">
                      <a href="status.php?cancelid='.$oid.'" class="text-light">Set as Cancelled</a>
                    </button>
                  </td>
                      </tr>';
                    }
