...
<body>
    ...
    <div class="container">
            <button class="btn btn-danger my-3">
                <a href="addproduct.php" class="text-light">Add Product</a>
            </button>
            <table class="table">
                  ...
                  if($result){
                    while($row = mysqli_fetch_assoc($result)){
                      ...
                      <td> 
                        ...
                        <a href="updateproduct.php?updateid='.$id.'"  class="text-light">Update</a>
                        </button>
                        </td>
                        <td> 
                     <button class="btn btn-danger btn-sm">
                       <a href="deleteproduct.php?deleteid='.$id.'" class="text-light">Delete</a>
                     </button>
                   </td>
                      </tr>';
                    }
